...
基本的には\[@nozmaさんの記事\]([https://qiita.com/nozma/items/808bce2f496eabd50ff1)と\[@uriさんの記事\](https://qiita.com/uri/items/69b2c05f7b3a21d3aad3)を参考にしています](https://qiita.com/nozma/items/808bce2f496eabd50ff1\)と%5B@uriさんの記事%5D\(https://qiita.com/uri/items/69b2c05f7b3a21d3aad3\)を参考にしています)。
...
また、`japan_map`という**フォルダごと**適当なディレクトリに保存して、その中の`N03-19_190101.shp`を読み込みます。
